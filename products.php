  ...
  <div id="content">
    ...
    <div class="centered-interface">
      <div class="interface-box" id="login">
        ...
        <input type="text" id="name" name="pprice" required>
      </div>
        <div class="form-group">
        <label for="date">Quantity:</label>
        <input type="text" id="address" name="pquantity" required>
      </div>

      <div class="form-group">
    <label for="fname">Seller's Name:</label>
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $pquantity = mysqli_real_escape_string($conn, $_POST["pquantity"]);
    $user_id = mysqli_real_escape_string($conn, $_POST["user_id"]);

    // Perform the database insertion
    $query = "INSERT INTO product (pname, pprice, pquantity, user_id) 
              VALUES ('$pname', '$pprice', '$pquantity', '$user_id')";
