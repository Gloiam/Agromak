  ...
  <div id="content">
    ...
    <div class="centered-interface">
      <div class="interface-box" id="login">
        ...
        <div>
        <label for="name">category <select >
...
<div class="form-group">
      ...
      <button class="btn" type="submit">Submit</a></button>
    </form>
    <div class="signup-link">
Already have an account? <a style="font-weight:bold" href="login.php">Sign In</a>
</div>
      </div>
    </div>
  </div>
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $query = "INSERT INTO farmer (username, dob, password, contact, gender, address) 
              VALUES ('$username', '$dob', '$password', '$contact', '$gender', '$address')";
